...
Nemo::Nemo(const sf::Sprite& sprite, sf::Vector2f size, sf::Vector2f scale):Moveable(sprite,size,scale)
{
	setFrameEnd(NEMO_FRAME_END);
	this->setisfish(true);
}

void Nemo::updateMovement(float dt)
{
