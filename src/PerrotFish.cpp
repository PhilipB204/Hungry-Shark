...
PerrotFish::PerrotFish(const sf::Sprite& sprite, sf::Vector2f size, sf::Vector2f scale):Moveable(sprite,size,scale)
{
	setFrameEnd(PERROTFISH_FRAME_END);
}

void PerrotFish::updateMovement(float dt)
{
