#include "..\include\PufFish.h"

PufFish::PufFish(const sf::Sprite& sprite, sf::Vector2f size, sf::Vector2f scale):Moveable(sprite,size,scale)
{
	setFrameEnd(PUFFISH_FRAME_END);

}

void PufFish::updateMovement(float dt)
{
